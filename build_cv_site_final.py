...
def build(lang):
    ...
    if is_en:
        ...
        t('Projects, Operations & Cultural Platforms', False, 24, 51.9, GRAY)
    else:
        t('GESTORA DE PROJETOS, PROGRAMAS E OPERAÇÕES', True, 24, 41.1, RUST)
        t('Projetos, Operações e Plataformas Culturais', False, 24, 51.9, GRAY)
    ...
    if is_en:
        sy = wrap('I build the structure, systems and governance model that allow organisations to deliver complex programmes, improve operations and turn strategy into measurable results.', False, SX, sy, GRAY, SMW, LH_SB)
    else:
        sy = wrap('Construo a estrutura, os sistemas e o modelo de governação que permitem às organizações executar programas complexos, melhorar operações e transformar estratégia em resultados mensuráveis.', False, SX, sy, GRAY, SMW, LH_SB)
    sy += 14.0
    ...
    if is_en:
        my = job('Co-Founder', '2022 – Present',
            ...
            ['End-to-end project management, strategy and platform positioning',
             ...
             'Budget planning, financial management and performance review'], my)
    else:
        my = job('Co-Fundadora', '2022 – Presente',
            ...
            ['Gestão end-to-end do projeto, estratégia e posicionamento da plataforma',
             ...
             'Planeamento financeiro, gestão orçamental e análise de desempenho'], my)

    hline(MX, my, MW, LINE, 0.4); my += 8

    if is_en:
        my = job('Project Manager', '2020 – 2023',
        ...
        my = job('Gestora de Projeto', '2020 – 2023',
    ...
    if is_en:
        ...
        my = job('Diretora de Operações', '2016 – 2020', 'Sabert Lda',
            ...
            ['Operações internacionais em Portugal, Espanha e China, incluindo B2B e e-commerce',
             ...
             'Parcerias comerciais, entrada em novos mercados e coordenação de programadores externos',
    ...
    addl = [
        ('Diretora Técnica' if not is_en else 'Technical Director', 'Feb 2024 – Dec 2024',
         'Associação de Apoio à Saúde Mental - O Salto',
         ('Gestão estratégica e operacional. Liderança de equipa técnica, governação, gestão orçamental e controlo financeiro. Gestão de risco, compliance, stakeholders e parcerias institucionais. Sistemas digitais e processos organizacionais. Coordenação e entrega de projetos.'
          if not is_en else
          'Strategic and operational management. Team leadership, governance, budget management and financial control. Risk management, compliance, stakeholder management and partnerships. Digital systems and organisational processes. Project coordination and delivery.')),
        ('Co-Fundadora' if not is_en else 'Co-Founder', '2013–2020',
         'Muito+ Inovação, Arte & Criatividade',
         ('Coordenação de produção, parcerias, gestão financeira e estratégia de comunicação em eventos culturais e mercados urbanos.'
          if not is_en else
          'Production coordination, partnerships, financial management and communication strategy across cultural events and urban markets.')),
    ...
    if is_en:
        ...
        t('· northgamefishing.com — service-based website with international positioning', False, P2X, p2y, DARK); p2y += LH
        t('· amabelia.com — brand-led website and visual positioning', False, P2X, p2y, DARK)
    else:
        ...
        t('· northgamefishing.com — website de serviços com orientação internacional', False, P2X, p2y, DARK); p2y += LH
        t('· amabelia.com — website de marca e posicionamento visual', False, P2X, p2y, DARK)
